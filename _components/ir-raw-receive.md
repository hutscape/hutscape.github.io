...
<img src="{{ site.url }}/assets/images/components/ir-raw-receive-appletv-remote-code.png" alt="IR Raw code received from Apple TV remote">

<img src="{{ site.url }}/assets/images/components/ir-raw-receive-appletv-remote-signals.png" alt="IR Raw signals received from Apple TV remote">

### Example of the Roomba remote

<img src="{{ site.url }}/assets/images/components/ir-raw-receive-roomba-remote-code.png" alt="IR Raw code received from Roomba remote">

<img src="{{ site.url }}/assets/images/components/ir-raw-receive-roomba-remote-signals.png" alt="IR Raw signals received from Roomba remote">
